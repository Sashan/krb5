...
main(int argc, char *argv[])
{
	...
	/*
	 * Sashan:
	 * The if () condition above is new in 1.17. I'm not sure if  
	 * _rpcsys() call below should be part of this else branch
	 * or whether it should be always executed. Like move it before
	 * if () condition above.
	 */
	/*
	 *  Solaris Kerberos
